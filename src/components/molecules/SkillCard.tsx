...
const SkillCard = ({ icon, title, description }: SkillCardProps) => {
  return (
    <div className="flex flex-col items-center bg-primary p-5 rounded-[10px] w-[180px] shadow-md transition-transform duration-300 ease-in-out cursor-pointer hover:scale-110 hover:bg-[#151078] group">
